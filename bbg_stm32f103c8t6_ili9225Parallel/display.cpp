...
{    
    ...
    writeCommandData(0x10, 0x0900);
    writeCommandData(0x11, 0x1038);
    writeCommandData(0x12, 0x1121);
    writeCommandData(0x13, 0x0065);
    writeCommandData(0x14, 0x5058);
    ...
    writeCommandData(0x50, 0x0400);
    writeCommandData(0x51, 0x060b);
    writeCommandData(0x52, 0x0c0a);
    writeCommandData(0x53, 0x0105);
    writeCommandData(0x54, 0x0a0c);
    writeCommandData(0x55, 0x0b06);
    writeCommandData(0x56, 0x0004);
    writeCommandData(0x57, 0x0501);
    writeCommandData(0x58, 0x0e00);
    writeCommandData(0x59, 0x000e);
