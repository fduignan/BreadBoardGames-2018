...
{    
    ...
    writeCommandData(0x0014, 0x0331);
    t.sleep(50);

    writeCommandData(0x0011, 0x0101);
    writeCommandData(0x0012, 0x000A);
    writeCommandData(0x0013, 0x0D45);
    writeCommandData(0x0010, 0x0164);
    writeCommandData(0x0012, 0x001A);
    t.sleep(50);
    writeCommandData(0x0013, 0x2D45);
    writeCommandData(0x0010, 0x0160);
    t.sleep(50);
    writeCommandData(0x0060, 0x2000);
    writeCommandData(0x0060, 0x0000);
    writeCommandData(0x0061, 0x0002);
    t.sleep(50);
    writeCommandData(0x0001, 0x011B);
    writeCommandData(0x0002, 0x0700);
    writeCommandData(0x0003, 0x1030);
    writeCommandData(0x0008, 0x0504);
    writeCommandData(0x0009, 0x0000);
    writeCommandData(0x000B, 0x0C30);
    writeCommandData(0x0021, 0x0000);
    writeCommandData(0x0030, 0x0606);
    writeCommandData(0x0031, 0x0606);
    writeCommandData(0x0032, 0x0606);
    writeCommandData(0x0033, 0x0803);
    writeCommandData(0x0034, 0x0202);
    writeCommandData(0x0035, 0x0404);
    writeCommandData(0x0036, 0x0404);
    writeCommandData(0x0037, 0x0404);
    writeCommandData(0x0038, 0x0402);
    writeCommandData(0x0039, 0x100C);
    writeCommandData(0x003A, 0x0101);
    writeCommandData(0x003B, 0x0101);
    writeCommandData(0x003C, 0x0101);
    writeCommandData(0x003D, 0x0101);
    writeCommandData(0x003E, 0x0001);
    writeCommandData(0x003F, 0x0001);
    writeCommandData(0x0042, 0xDB00);
    writeCommandData(0x0044, 0xAF00);
    writeCommandData(0x0045, 0xDB00);
    t.sleep(50);
    writeCommandData(0x0071, 0x0040);
    writeCommandData(0x0072, 0x0002);
    t.sleep(50);
    writeCommandData(0x0010, 0x6060);
    writeCommandData(0x0007, 0x0005);
    t.sleep(50);
    writeCommandData(0x0007, 0x0025);
    writeCommandData(0x0007, 0x0027);
    t.sleep(50);
    writeCommandData(0x0007, 0x0037);
    writeCommandData(0x0021, 0x0000);
...
void display::openAperture(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2)
{
    ...
    writeCommandData(0x44, (x2<<8)+x1); 
    writeCommandData(0x45, (y2<<8)+y1); 
    writeCommandData(0x21, (y1<<8)+x1); 
